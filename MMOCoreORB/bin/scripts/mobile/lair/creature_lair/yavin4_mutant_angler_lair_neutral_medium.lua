yavin4_mutant_angler_lair_neutral_medium = Lair:new {
	mobiles = {{"mutant_angler", 1}},
	spawnLimit = 15,
...
addLairTemplate("yavin4_mutant_angler_lair_neutral_medium", yavin4_mutant_angler_lair_neutral_medium)
