object_draft_schematic_bio_engineer_creature_creature_mutated_cu_pa = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_cu_pa:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Co-henpa",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_cu_pa_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_cu_pa, "object/draft_schematic/bio_engineer/creature/creature_mutated_cu_pa.iff")