object_draft_schematic_bio_engineer_creature_creature_katarn = object_draft_schematic_bio_engineer_creature_shared_creature_katarn:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Katarn",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/katarn_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_katarn, "object/draft_schematic/bio_engineer/creature/creature_katarn.iff")