object_draft_schematic_bio_engineer_creature_creature_squill = object_draft_schematic_bio_engineer_creature_shared_creature_squill:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Squill",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/squill_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_squill, "object/draft_schematic/bio_engineer/creature/creature_squill.iff")