object_draft_schematic_bio_engineer_creature_creature_tulrus = object_draft_schematic_bio_engineer_creature_shared_creature_tulrus:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Tulrus",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/tulrus_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_tulrus, "object/draft_schematic/bio_engineer/creature/creature_tulrus.iff")