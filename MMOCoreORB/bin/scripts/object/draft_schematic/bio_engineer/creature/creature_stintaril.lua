object_draft_schematic_bio_engineer_creature_creature_stintaril = object_draft_schematic_bio_engineer_creature_shared_creature_stintaril:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Stintaril",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/stintaril_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_stintaril, "object/draft_schematic/bio_engineer/creature/creature_stintaril.iff")