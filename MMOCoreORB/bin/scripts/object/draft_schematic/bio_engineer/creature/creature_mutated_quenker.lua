object_draft_schematic_bio_engineer_creature_creature_mutated_quenker = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_quenker:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Winged Quenker",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_quenker_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_quenker, "object/draft_schematic/bio_engineer/creature/creature_mutated_quenker.iff")