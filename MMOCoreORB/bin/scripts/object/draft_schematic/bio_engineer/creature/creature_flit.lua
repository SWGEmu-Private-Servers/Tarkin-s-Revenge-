object_draft_schematic_bio_engineer_creature_creature_flit = object_draft_schematic_bio_engineer_creature_shared_creature_flit:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Flit",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/flit_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_flit, "object/draft_schematic/bio_engineer/creature/creature_flit.iff")