object_draft_schematic_bio_engineer_creature_creature_vynock = object_draft_schematic_bio_engineer_creature_shared_creature_vynock:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Vynock",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/vynock_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_vynock, "object/draft_schematic/bio_engineer/creature/creature_vynock.iff")