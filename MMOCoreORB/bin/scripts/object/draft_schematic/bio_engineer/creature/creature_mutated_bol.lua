object_draft_schematic_bio_engineer_creature_creature_mutated_bol = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_bol:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Sligtooth Bol",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_bol_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_bol, "object/draft_schematic/bio_engineer/creature/creature_mutated_bol.iff")