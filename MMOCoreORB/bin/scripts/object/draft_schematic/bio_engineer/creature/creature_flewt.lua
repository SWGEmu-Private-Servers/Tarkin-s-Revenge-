object_draft_schematic_bio_engineer_creature_creature_flewt = object_draft_schematic_bio_engineer_creature_shared_creature_flewt:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Flewt",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/flewt_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_flewt, "object/draft_schematic/bio_engineer/creature/creature_flewt.iff")