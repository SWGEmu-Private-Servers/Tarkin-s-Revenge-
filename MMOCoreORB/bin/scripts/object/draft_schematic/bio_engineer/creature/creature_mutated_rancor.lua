object_draft_schematic_bio_engineer_creature_creature_mutated_rancor = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_rancor:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Spined Rancor",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_rancor_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_rancor, "object/draft_schematic/bio_engineer/creature/creature_mutated_rancor.iff")