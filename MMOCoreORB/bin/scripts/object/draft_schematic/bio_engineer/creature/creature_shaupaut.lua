object_draft_schematic_bio_engineer_creature_creature_shaupaut = object_draft_schematic_bio_engineer_creature_shared_creature_shaupaut:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Shaupaut",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/shaupaut_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_shaupaut, "object/draft_schematic/bio_engineer/creature/creature_shaupaut.iff")