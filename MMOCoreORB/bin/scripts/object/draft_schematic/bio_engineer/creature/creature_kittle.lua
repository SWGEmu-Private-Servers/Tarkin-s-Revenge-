object_draft_schematic_bio_engineer_creature_creature_kittle = object_draft_schematic_bio_engineer_creature_shared_creature_kittle:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Kittle",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/kittle_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kittle, "object/draft_schematic/bio_engineer/creature/creature_kittle.iff")