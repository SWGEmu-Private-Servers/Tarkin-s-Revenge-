object_draft_schematic_bio_engineer_creature_creature_baz_nitch = object_draft_schematic_bio_engineer_creature_shared_creature_baz_nitch:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Baz Nitch",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/baz_nitch_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_baz_nitch, "object/draft_schematic/bio_engineer/creature/creature_baz_nitch.iff")