object_draft_schematic_bio_engineer_creature_creature_scorpion_kliknik = object_draft_schematic_bio_engineer_creature_shared_creature_scorpion_kliknik:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Scorpion Kliknik",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/scorpion_kliknik_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_scorpion_kliknik, "object/draft_schematic/bio_engineer/creature/creature_scorpion_kliknik.iff")