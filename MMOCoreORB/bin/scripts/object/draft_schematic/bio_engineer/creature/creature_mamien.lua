object_draft_schematic_bio_engineer_creature_creature_mamien = object_draft_schematic_bio_engineer_creature_shared_creature_mamien:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Mamien",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mamien_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mamien, "object/draft_schematic/bio_engineer/creature/creature_mamien.iff")