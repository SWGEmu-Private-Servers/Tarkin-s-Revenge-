object_draft_schematic_bio_engineer_creature_creature_mutated_dewback = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_dewback:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Horned Dewback",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_dewback_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_dewback, "object/draft_schematic/bio_engineer/creature/creature_mutated_dewback.iff")