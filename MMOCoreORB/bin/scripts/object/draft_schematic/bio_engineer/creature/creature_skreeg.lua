object_draft_schematic_bio_engineer_creature_creature_skreeg = object_draft_schematic_bio_engineer_creature_shared_creature_skreeg:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Skreeg",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/skreeg_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_skreeg, "object/draft_schematic/bio_engineer/creature/creature_skreeg.iff")