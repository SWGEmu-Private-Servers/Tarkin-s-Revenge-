object_draft_schematic_bio_engineer_creature_creature_mutated_cat = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_cat:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Fanged Tiglon",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_cat_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_cat, "object/draft_schematic/bio_engineer/creature/creature_mutated_cat.iff")