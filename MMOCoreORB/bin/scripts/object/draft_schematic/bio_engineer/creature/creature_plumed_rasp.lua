object_draft_schematic_bio_engineer_creature_creature_plumed_rasp = object_draft_schematic_bio_engineer_creature_shared_creature_plumed_rasp:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Plumed Rasp",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/plumed_rasp_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_plumed_rasp, "object/draft_schematic/bio_engineer/creature/creature_plumed_rasp.iff")