object_draft_schematic_bio_engineer_creature_creature_crystal_snake = object_draft_schematic_bio_engineer_creature_shared_creature_crystal_snake:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Crystal Snake",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/crystal_snake_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_crystal_snake, "object/draft_schematic/bio_engineer/creature/creature_crystal_snake.iff")