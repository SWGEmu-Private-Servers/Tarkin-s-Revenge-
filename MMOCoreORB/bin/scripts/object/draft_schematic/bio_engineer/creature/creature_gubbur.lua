object_draft_schematic_bio_engineer_creature_creature_gubbur = object_draft_schematic_bio_engineer_creature_shared_creature_gubbur:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Gubbur",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/gubbur_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_gubbur, "object/draft_schematic/bio_engineer/creature/creature_gubbur.iff")