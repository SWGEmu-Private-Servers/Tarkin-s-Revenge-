object_draft_schematic_bio_engineer_creature_creature_uller = object_draft_schematic_bio_engineer_creature_shared_creature_uller:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Uller",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/uller_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_uller, "object/draft_schematic/bio_engineer/creature/creature_uller.iff")