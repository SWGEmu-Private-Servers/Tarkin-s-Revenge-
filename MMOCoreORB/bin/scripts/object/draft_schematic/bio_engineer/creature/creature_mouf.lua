object_draft_schematic_bio_engineer_creature_creature_mouf = object_draft_schematic_bio_engineer_creature_shared_creature_mouf:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Mouf",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mouf_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mouf, "object/draft_schematic/bio_engineer/creature/creature_mouf.iff")