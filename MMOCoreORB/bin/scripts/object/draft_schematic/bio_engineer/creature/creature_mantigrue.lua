object_draft_schematic_bio_engineer_creature_creature_mantigrue = object_draft_schematic_bio_engineer_creature_shared_creature_mantigrue:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Mantigrue",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mantigrue_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mantigrue, "object/draft_schematic/bio_engineer/creature/creature_mantigrue.iff")