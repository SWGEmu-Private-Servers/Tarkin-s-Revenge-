object_draft_schematic_bio_engineer_creature_creature_mynock = object_draft_schematic_bio_engineer_creature_shared_creature_mynock:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Mynock",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mynock_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mynock, "object/draft_schematic/bio_engineer/creature/creature_mynock.iff")