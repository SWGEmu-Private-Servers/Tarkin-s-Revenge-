object_draft_schematic_bio_engineer_creature_creature_armored_tauntaun = object_draft_schematic_bio_engineer_creature_shared_creature_armored_tauntaun:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Armored Tauntaun",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/armored_tauntaun_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_armored_tauntaun, "object/draft_schematic/bio_engineer/creature/creature_armored_tauntaun.iff")