object_draft_schematic_bio_engineer_creature_creature_mutated_griffon = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_griffon:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Horned Raptor",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_griffon_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_griffon, "object/draft_schematic/bio_engineer/creature/creature_mutated_griffon.iff")