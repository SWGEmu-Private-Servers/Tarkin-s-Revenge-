object_draft_schematic_bio_engineer_creature_creature_kubaza_beetle = object_draft_schematic_bio_engineer_creature_shared_creature_kubaza_beetle:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Kubaza Beetle",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/kubaza_beetle_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kubaza_beetle, "object/draft_schematic/bio_engineer/creature/creature_kubaza_beetle.iff")