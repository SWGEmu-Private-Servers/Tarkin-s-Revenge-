object_draft_schematic_bio_engineer_creature_creature_mutated_acklay = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_acklay:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Mutant Acklay",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_acklay_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_acklay, "object/draft_schematic/bio_engineer/creature/creature_mutated_acklay.iff")