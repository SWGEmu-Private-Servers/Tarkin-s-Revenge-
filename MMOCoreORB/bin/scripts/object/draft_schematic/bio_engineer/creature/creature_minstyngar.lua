object_draft_schematic_bio_engineer_creature_creature_minstyngar = object_draft_schematic_bio_engineer_creature_shared_creature_minstyngar:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Minstyngar",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/minstyngar_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_minstyngar, "object/draft_schematic/bio_engineer/creature/creature_minstyngar.iff")