object_draft_schematic_bio_engineer_creature_creature_lantern_bird = object_draft_schematic_bio_engineer_creature_shared_creature_lantern_bird:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Lantern Bird",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/lantern_bird_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_lantern_bird, "object/draft_schematic/bio_engineer/creature/creature_lantern_bird.iff")