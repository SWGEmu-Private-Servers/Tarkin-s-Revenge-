object_draft_schematic_bio_engineer_creature_creature_spined_puc = object_draft_schematic_bio_engineer_creature_shared_creature_spined_puc:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Spined Puc",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/spined_puc_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_spined_puc, "object/draft_schematic/bio_engineer/creature/creature_spined_puc.iff")