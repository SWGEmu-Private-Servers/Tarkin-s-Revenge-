object_draft_schematic_bio_engineer_creature_creature_tanray = object_draft_schematic_bio_engineer_creature_shared_creature_tanray:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Tanray",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/tanray_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_tanray, "object/draft_schematic/bio_engineer/creature/creature_tanray.iff")