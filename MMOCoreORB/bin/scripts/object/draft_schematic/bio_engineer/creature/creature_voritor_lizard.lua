object_draft_schematic_bio_engineer_creature_creature_voritor_lizard = object_draft_schematic_bio_engineer_creature_shared_creature_voritor_lizard:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Voritor Lizard",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/voritor_lizard_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_voritor_lizard, "object/draft_schematic/bio_engineer/creature/creature_voritor_lizard.iff")