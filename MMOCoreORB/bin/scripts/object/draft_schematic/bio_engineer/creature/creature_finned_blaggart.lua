object_draft_schematic_bio_engineer_creature_creature_finned_blaggart = object_draft_schematic_bio_engineer_creature_shared_creature_finned_blaggart:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Finned Blaggart",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/finned_blaggart_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_finned_blaggart, "object/draft_schematic/bio_engineer/creature/creature_finned_blaggart.iff")