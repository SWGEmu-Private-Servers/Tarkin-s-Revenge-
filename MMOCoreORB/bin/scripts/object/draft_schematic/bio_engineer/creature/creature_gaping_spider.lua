object_draft_schematic_bio_engineer_creature_creature_gaping_spider = object_draft_schematic_bio_engineer_creature_shared_creature_gaping_spider:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Gaping Spider",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/gaping_spider_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_gaping_spider, "object/draft_schematic/bio_engineer/creature/creature_gaping_spider.iff")