object_draft_schematic_bio_engineer_creature_creature_womp_rat = object_draft_schematic_bio_engineer_creature_shared_creature_womp_rat:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Womp Rat",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/womp_rat_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_womp_rat, "object/draft_schematic/bio_engineer/creature/creature_womp_rat.iff")