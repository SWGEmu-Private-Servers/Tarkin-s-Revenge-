object_draft_schematic_bio_engineer_creature_creature_worrt = object_draft_schematic_bio_engineer_creature_shared_creature_worrt:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Worrt",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/worrt_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_worrt, "object/draft_schematic/bio_engineer/creature/creature_worrt.iff")