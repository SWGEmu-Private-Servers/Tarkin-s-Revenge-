object_draft_schematic_bio_engineer_creature_creature_tanc_mite = object_draft_schematic_bio_engineer_creature_shared_creature_tanc_mite:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Tanc Mite",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/tanc_mite_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_tanc_mite, "object/draft_schematic/bio_engineer/creature/creature_tanc_mite.iff")