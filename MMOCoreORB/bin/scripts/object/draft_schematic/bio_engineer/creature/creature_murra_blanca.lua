object_draft_schematic_bio_engineer_creature_creature_murra_blanca = object_draft_schematic_bio_engineer_creature_shared_creature_murra_blanca:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Kahmurra Blanca",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/murra_blanca_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_murra_blanca, "object/draft_schematic/bio_engineer/creature/creature_murra_blanca.iff")