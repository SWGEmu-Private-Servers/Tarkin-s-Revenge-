object_draft_schematic_bio_engineer_creature_creature_razor_angler = object_draft_schematic_bio_engineer_creature_shared_creature_razor_angler:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Razor Angler",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/razor_angler_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_razor_angler, "object/draft_schematic/bio_engineer/creature/creature_razor_angler.iff")