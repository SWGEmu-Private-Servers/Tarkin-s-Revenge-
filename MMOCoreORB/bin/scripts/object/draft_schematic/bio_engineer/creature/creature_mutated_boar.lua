object_draft_schematic_bio_engineer_creature_creature_mutated_boar = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_boar:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Boar Wolfcale",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_boar_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_boar, "object/draft_schematic/bio_engineer/creature/creature_mutated_boar.iff")