object_draft_schematic_bio_engineer_creature_creature_gualaar = object_draft_schematic_bio_engineer_creature_shared_creature_gualaar:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Gualaar",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/gualaar_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_gualaar, "object/draft_schematic/bio_engineer/creature/creature_gualaar.iff")