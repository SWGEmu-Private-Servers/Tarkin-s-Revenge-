object_draft_schematic_bio_engineer_creature_creature_barbed_quenker = object_draft_schematic_bio_engineer_creature_shared_creature_barbed_quenker:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Barbed Quenker",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/barbed_quenker_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_barbed_quenker, "object/draft_schematic/bio_engineer/creature/creature_barbed_quenker.iff")