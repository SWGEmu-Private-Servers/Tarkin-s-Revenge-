object_draft_schematic_bio_engineer_creature_creature_borgle = object_draft_schematic_bio_engineer_creature_shared_creature_borgle:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Borgle",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/borgle_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_borgle, "object/draft_schematic/bio_engineer/creature/creature_borgle.iff")