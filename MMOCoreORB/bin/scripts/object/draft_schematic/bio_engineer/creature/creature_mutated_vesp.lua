object_draft_schematic_bio_engineer_creature_creature_mutated_vesp = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_vesp:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Barbed Vesp",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_vesp_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_vesp, "object/draft_schematic/bio_engineer/creature/creature_mutated_vesp.iff")