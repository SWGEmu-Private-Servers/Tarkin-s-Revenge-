object_draft_schematic_bio_engineer_creature_creature_blackwing_rancor = object_draft_schematic_bio_engineer_creature_shared_creature_blackwing_rancor:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Blackwing Rancor",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/blackwing_rancor_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_blackwing_rancor, "object/draft_schematic/bio_engineer/creature/creature_blackwing_rancor.iff")