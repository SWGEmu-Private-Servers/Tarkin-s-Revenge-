object_draft_schematic_bio_engineer_creature_creature_mutated_borgax = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_borgax:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Borgax",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_borgax_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_borgax, "object/draft_schematic/bio_engineer/creature/creature_mutated_borgax.iff")