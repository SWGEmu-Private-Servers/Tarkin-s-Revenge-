object_draft_schematic_bio_engineer_creature_creature_nuna = object_draft_schematic_bio_engineer_creature_shared_creature_nuna:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Nuna",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/nuna_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_nuna, "object/draft_schematic/bio_engineer/creature/creature_nuna.iff")