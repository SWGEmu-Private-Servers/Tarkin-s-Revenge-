object_draft_schematic_bio_engineer_creature_creature_horned_rasp = object_draft_schematic_bio_engineer_creature_shared_creature_horned_rasp:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Horned Rasp",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/horned_rasp_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_horned_rasp, "object/draft_schematic/bio_engineer/creature/creature_horned_rasp.iff")