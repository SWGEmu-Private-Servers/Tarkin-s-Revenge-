object_draft_schematic_bio_engineer_creature_creature_armored_dewback = object_draft_schematic_bio_engineer_creature_shared_creature_armored_dewback:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Armored Dewback",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/armored_dewback_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_armored_dewback, "object/draft_schematic/bio_engineer/creature/creature_armored_dewback.iff")