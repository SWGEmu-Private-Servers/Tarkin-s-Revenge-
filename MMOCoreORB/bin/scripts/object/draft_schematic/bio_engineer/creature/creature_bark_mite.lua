object_draft_schematic_bio_engineer_creature_creature_bark_mite = object_draft_schematic_bio_engineer_creature_shared_creature_bark_mite:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Bark Mite",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/bark_mite_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_bark_mite, "object/draft_schematic/bio_engineer/creature/creature_bark_mite.iff")