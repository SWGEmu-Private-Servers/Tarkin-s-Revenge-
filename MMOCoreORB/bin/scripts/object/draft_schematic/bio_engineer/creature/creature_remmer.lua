object_draft_schematic_bio_engineer_creature_creature_remmer = object_draft_schematic_bio_engineer_creature_shared_creature_remmer:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Remmer",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/remmer_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_remmer, "object/draft_schematic/bio_engineer/creature/creature_remmer.iff")