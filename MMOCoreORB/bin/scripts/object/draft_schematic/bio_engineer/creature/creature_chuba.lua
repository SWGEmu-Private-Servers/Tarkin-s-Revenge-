object_draft_schematic_bio_engineer_creature_creature_chuba = object_draft_schematic_bio_engineer_creature_shared_creature_chuba:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Chuba",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/chuba_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_chuba, "object/draft_schematic/bio_engineer/creature/creature_chuba.iff")