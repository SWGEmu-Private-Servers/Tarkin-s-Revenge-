object_draft_schematic_bio_engineer_creature_creature_mutated_durni = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_durni:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Vorpal Durni",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_durni_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_durni, "object/draft_schematic/bio_engineer/creature/creature_mutated_durni.iff")