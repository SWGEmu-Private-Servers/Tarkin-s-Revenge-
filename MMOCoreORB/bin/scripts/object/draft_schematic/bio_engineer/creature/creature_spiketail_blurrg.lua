object_draft_schematic_bio_engineer_creature_creature_spiketail_blurrg = object_draft_schematic_bio_engineer_creature_shared_creature_spiketail_blurrg:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Spiketail Blurrg",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/spiketail_blurrg_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_spiketail_blurrg, "object/draft_schematic/bio_engineer/creature/creature_spiketail_blurrg.iff")