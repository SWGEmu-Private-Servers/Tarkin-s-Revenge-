object_draft_schematic_bio_engineer_creature_creature_uwari_beetle = object_draft_schematic_bio_engineer_creature_shared_creature_uwari_beetle:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Uwari Beetle",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/uwari_beetle_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_uwari_beetle, "object/draft_schematic/bio_engineer/creature/creature_uwari_beetle.iff")