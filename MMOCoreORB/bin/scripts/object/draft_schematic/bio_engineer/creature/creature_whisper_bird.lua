object_draft_schematic_bio_engineer_creature_creature_whisper_bird = object_draft_schematic_bio_engineer_creature_shared_creature_whisper_bird:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Whisper Bird",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/whisper_bird_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_whisper_bird, "object/draft_schematic/bio_engineer/creature/creature_whisper_bird.iff")