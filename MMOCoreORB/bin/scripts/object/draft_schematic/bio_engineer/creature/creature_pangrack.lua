object_draft_schematic_bio_engineer_creature_creature_pangrack = object_draft_schematic_bio_engineer_creature_shared_creature_pangrack:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Pangrack",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/pangrack_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_pangrack, "object/draft_schematic/bio_engineer/creature/creature_pangrack.iff")