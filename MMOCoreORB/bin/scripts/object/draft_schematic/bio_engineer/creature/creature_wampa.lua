object_draft_schematic_bio_engineer_creature_creature_wampa = object_draft_schematic_bio_engineer_creature_shared_creature_wampa:new {
   ...
   targetTemplate = "object/tangible/deed/pet_deed/wampa_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_wampa, "object/draft_schematic/bio_engineer/creature/creature_wampa.iff")