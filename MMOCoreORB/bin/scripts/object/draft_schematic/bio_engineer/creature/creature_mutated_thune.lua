object_draft_schematic_bio_engineer_creature_creature_mutated_thune = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_thune:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Tusked Bull Thune",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_thune_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_thune, "object/draft_schematic/bio_engineer/creature/creature_mutated_thune.iff")