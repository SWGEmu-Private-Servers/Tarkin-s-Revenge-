object_draft_schematic_bio_engineer_creature_creature_fanned_rawl = object_draft_schematic_bio_engineer_creature_shared_creature_fanned_rawl:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Fanned Rawl",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/fanned_rawl_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_fanned_rawl, "object/draft_schematic/bio_engineer/creature/creature_fanned_rawl.iff")