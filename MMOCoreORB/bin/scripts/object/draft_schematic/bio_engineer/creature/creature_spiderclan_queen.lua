object_draft_schematic_bio_engineer_creature_creature_spiderclan_queen = object_draft_schematic_bio_engineer_creature_shared_creature_spiderclan_queen:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Spiderclan Queen",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/spiderclan_queen_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_spiderclan_queen, "object/draft_schematic/bio_engineer/creature/creature_spiderclan_queen.iff")