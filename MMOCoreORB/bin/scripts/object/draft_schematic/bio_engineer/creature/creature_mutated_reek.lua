object_draft_schematic_bio_engineer_creature_creature_mutated_reek = object_draft_schematic_bio_engineer_creature_shared_creature_mutated_reek:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Ring-Nosed Reek",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/mutated_reek_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_mutated_reek, "object/draft_schematic/bio_engineer/creature/creature_mutated_reek.iff")