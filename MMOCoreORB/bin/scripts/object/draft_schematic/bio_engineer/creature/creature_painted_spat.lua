object_draft_schematic_bio_engineer_creature_creature_painted_spat = object_draft_schematic_bio_engineer_creature_shared_creature_painted_spat:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Painted Spat",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/painted_spat_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_painted_spat, "object/draft_schematic/bio_engineer/creature/creature_painted_spat.iff")