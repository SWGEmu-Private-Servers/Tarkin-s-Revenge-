object_draft_schematic_bio_engineer_creature_creature_kai_tok = object_draft_schematic_bio_engineer_creature_shared_creature_kai_tok:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Kai Tok",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/kai_tok_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_kai_tok, "object/draft_schematic/bio_engineer/creature/creature_kai_tok.iff")