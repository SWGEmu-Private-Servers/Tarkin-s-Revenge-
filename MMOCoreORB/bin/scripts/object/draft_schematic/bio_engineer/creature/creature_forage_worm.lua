object_draft_schematic_bio_engineer_creature_creature_forage_worm = object_draft_schematic_bio_engineer_creature_shared_creature_forage_worm:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Forage Worm",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/forage_worm_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_forage_worm, "object/draft_schematic/bio_engineer/creature/creature_forage_worm.iff")