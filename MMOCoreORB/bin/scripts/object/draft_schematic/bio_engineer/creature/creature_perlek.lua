object_draft_schematic_bio_engineer_creature_creature_perlek = object_draft_schematic_bio_engineer_creature_shared_creature_perlek:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,

   customObjectName = "Perlek",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/perlek_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_perlek, "object/draft_schematic/bio_engineer/creature/creature_perlek.iff")