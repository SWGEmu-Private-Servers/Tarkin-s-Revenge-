object_draft_schematic_bio_engineer_creature_creature_dwarf_nuna = object_draft_schematic_bio_engineer_creature_shared_creature_dwarf_nuna:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Dwarf Nuna",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/dwarf_nuna_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_dwarf_nuna, "object/draft_schematic/bio_engineer/creature/creature_dwarf_nuna.iff")