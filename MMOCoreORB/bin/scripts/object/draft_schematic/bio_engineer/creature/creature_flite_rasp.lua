object_draft_schematic_bio_engineer_creature_creature_flite_rasp = object_draft_schematic_bio_engineer_creature_shared_creature_flite_rasp:new {

   templateType = DRAFTSCHEMATIC,
   factoryCrateSize = 0,	

   customObjectName = "Flite Rasp",
   ...
   targetTemplate = "object/tangible/deed/pet_deed/flite_rasp_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_bio_engineer_creature_creature_flite_rasp, "object/draft_schematic/bio_engineer/creature/creature_flite_rasp.iff")