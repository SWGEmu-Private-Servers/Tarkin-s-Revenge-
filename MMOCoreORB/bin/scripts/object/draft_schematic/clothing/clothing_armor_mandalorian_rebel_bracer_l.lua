object_draft_schematic_clothing_clothing_armor_mandalorian_rebel_bracer_l = object_draft_schematic_clothing_shared_clothing_armor_mandalorian_rebel_bracer_l:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_mandalorian_rebel_bracer_l, "object/draft_schematic/clothing/clothing_armor_mandalorian_rebel_bracer_l.iff")
