object_draft_schematic_clothing_clothing_armor_mandalorian_imperial_bicep_l = object_draft_schematic_clothing_shared_clothing_armor_mandalorian_imperial_bicep_l:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_mandalorian_imperial_bicep_l, "object/draft_schematic/clothing/clothing_armor_mandalorian_imperial_bicep_l.iff")