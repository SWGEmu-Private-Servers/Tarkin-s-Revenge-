object_draft_schematic_clothing_clothing_armor_mandalorian_imperial_leggings = object_draft_schematic_clothing_shared_clothing_armor_mandalorian_imperial_leggings:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_mandalorian_imperial_leggings, "object/draft_schematic/clothing/clothing_armor_mandalorian_imperial_leggings.iff")