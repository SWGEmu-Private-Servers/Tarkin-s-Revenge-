object_draft_schematic_clothing_clothing_armor_mandalorian_imperial_chest = object_draft_schematic_clothing_shared_clothing_armor_mandalorian_imperial_chest:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_mandalorian_imperial_chest, "object/draft_schematic/clothing/clothing_armor_mandalorian_imperial_chest.iff")
