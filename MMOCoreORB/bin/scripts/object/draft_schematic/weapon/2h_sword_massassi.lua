object_draft_schematic_weapon_2h_sword_massassi = object_draft_schematic_weapon_shared_2h_sword_massassi:new {
   ...
   resourceTypes = {"steel_duralloy", "aluminum_linksteel", "petrochem_inert_polymer", "object/tangible/loot/dungeon/tarkin_custom/shared_massassi_blade.iff",  "object/tangible/component/weapon/shared_sword_core.iff"},
