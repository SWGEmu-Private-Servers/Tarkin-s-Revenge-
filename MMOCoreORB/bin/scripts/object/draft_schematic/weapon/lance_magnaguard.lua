object_draft_schematic_weapon_lance_magnaguard = object_draft_schematic_weapon_shared_lance_magnaguard:new {
   ...
   resourceTypes = {"aluminum_perovskitic", "iron", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_magnaguard_capacitor.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
