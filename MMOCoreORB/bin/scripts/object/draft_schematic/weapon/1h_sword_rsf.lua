object_draft_schematic_weapon_1h_sword_rsf = object_draft_schematic_weapon_shared_1h_sword_rsf:new {
   ...
   resourceTypes = {"iron", "steel", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_rsf_medallion.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
