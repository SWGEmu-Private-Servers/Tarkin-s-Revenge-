object_draft_schematic_weapon_heavy_cryo_projector = object_draft_schematic_weapon_shared_heavy_cryo_projector:new {
   ...
   resourceTypes = {"iron_kammris", "aluminum_linksteel", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_barrel_heavy_cryo_projector.iff", "steel", "object/tangible/component/weapon/shared_stock.iff"},
