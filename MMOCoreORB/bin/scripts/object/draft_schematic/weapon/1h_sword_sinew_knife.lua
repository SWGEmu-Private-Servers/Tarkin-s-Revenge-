object_draft_schematic_weapon_1h_sword_sinew_knife = object_draft_schematic_weapon_shared_1h_sword_sinew_knife:new {
   ...
   resourceTypes = {"steel", "iron", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_webweaver_sinew.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
