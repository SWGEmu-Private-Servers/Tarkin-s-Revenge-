object_draft_schematic_weapon_pistol_ion_relic = object_draft_schematic_weapon_shared_pistol_ion_relic:new {
   ...
   resourceTypes = {"iron_kammris", "copper_polysteel", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_coil_pistol_ion_relic.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
