object_draft_schematic_weapon_pistol_alliance_disruptor = object_draft_schematic_weapon_shared_pistol_alliance_disruptor:new {
   ...
   resourceTypes = {"iron_kammris", "metal_nonferrous", "chemical", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_coil_pistol_alliance_disruptor.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
