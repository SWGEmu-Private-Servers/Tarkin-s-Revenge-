object_draft_schematic_weapon_1h_sword_elite_gaderiffi = object_draft_schematic_weapon_shared_1h_sword_elite_gaderiffi:new {
   ...
   resourceTypes = {"iron", "steel", "metal", "object/tangible/loot/dungeon/tarkin_custom/shared_tusken_mace_head.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
