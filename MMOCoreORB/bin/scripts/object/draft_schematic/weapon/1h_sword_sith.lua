object_draft_schematic_weapon_1h_sword_sith = object_draft_schematic_weapon_shared_1h_sword_sith:new {
   ...
   resourceTypes = {"steel_ditanium", "metal", "aluminum_perovskitic", "object/tangible/loot/dungeon/tarkin_custom/shared_sith_blade.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
