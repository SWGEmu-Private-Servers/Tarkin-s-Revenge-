object_draft_schematic_weapon_pistol_crusader = object_draft_schematic_weapon_shared_pistol_crusader:new {
   ...
   resourceTypes = {"aluminum", "steel", "chemical", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_barrel_pistol_crusader.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
