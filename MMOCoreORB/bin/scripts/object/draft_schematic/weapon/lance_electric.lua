object_draft_schematic_weapon_lance_electric = object_draft_schematic_weapon_shared_lance_electric:new {
   ...
   resourceTypes = {"steel_duranium", "iron", "metal", "aluminum", "object/tangible/loot/dungeon/tarkin_custom/shared_electric_polearm_power_supply.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
