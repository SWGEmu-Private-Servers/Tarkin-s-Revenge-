object_draft_schematic_weapon_pistol_disruptor = object_draft_schematic_weapon_shared_pistol_disruptor:new {
   ...
   resourceTypes = {"steel_quadranium", "iron_kammris", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_coil_pistol_disruptor.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
