object_draft_schematic_weapon_1h_sword_urnsoriis = object_draft_schematic_weapon_shared_1h_sword_urnsoriis:new {
   ...
   resourceTypes = {"steel", "iron", "metal", "aluminum", "object/tangible/loot/dungeon/tarkin_custom/shared_urnsoris_blade.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
