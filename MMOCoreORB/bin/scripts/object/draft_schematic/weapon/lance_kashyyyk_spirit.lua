object_draft_schematic_weapon_lance_kashyyyk_spirit = object_draft_schematic_weapon_shared_lance_kashyyyk_spirit:new {
   ...
   resourceTypes = {"steel_ditanium", "iron", "metal", "aluminum", "object/tangible/loot/dungeon/tarkin_custom/shared_spirit_blade.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
