object_draft_schematic_weapon_pistol_flechette = object_draft_schematic_weapon_shared_pistol_flechette:new {
   ...
   resourceTypes = {"iron_kammris", "metal_nonferrous", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_barrel_pistol_flechette.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
