object_draft_schematic_weapon_heavy_reaper_cannon = object_draft_schematic_weapon_shared_heavy_reaper_cannon:new {
   ...
   resourceTypes = {"steel_duralloy", "copper_polysteel", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_barrel_heavy_reaper_cannon.iff", "steel", "object/tangible/component/weapon/shared_stock.iff"},
