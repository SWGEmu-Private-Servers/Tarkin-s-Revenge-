object_draft_schematic_weapon_pistol_tchotchee = object_draft_schematic_weapon_shared_pistol_tchotchee:new {
   ...
   resourceTypes = {"iron", "steel", "chemical", "object/tangible/component/weapon/shared_projectile_feed_mechanism.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_muzzle_pistol_tchotchee.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
