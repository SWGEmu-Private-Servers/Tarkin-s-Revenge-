object_draft_schematic_weapon_2h_sword_kashyyyk = object_draft_schematic_weapon_shared_2h_sword_kashyyyk:new {
   ...
   resourceTypes = {"iron_kammris", "copper_polysteel", "petrochem_inert_polymer", "object/tangible/loot/dungeon/tarkin_custom/shared_kashyyyk_blade.iff",  "object/tangible/component/weapon/shared_sword_core.iff"},
