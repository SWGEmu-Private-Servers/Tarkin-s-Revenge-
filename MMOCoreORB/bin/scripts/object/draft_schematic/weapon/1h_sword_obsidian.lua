object_draft_schematic_weapon_1h_sword_obsidian = object_draft_schematic_weapon_shared_1h_sword_obsidian:new {
   ...
   resourceTypes = {"steel_duranium", "metal", "copper_polysteel", "object/tangible/loot/dungeon/tarkin_custom/shared_obsidian_blade.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
