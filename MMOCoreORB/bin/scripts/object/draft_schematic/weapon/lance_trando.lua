object_draft_schematic_weapon_lance_trando = object_draft_schematic_weapon_shared_lance_trando:new {
   ...
   resourceTypes = {"aluminum_phrik", "steel", "metal","object/tangible/loot/dungeon/tarkin_custom/shared_trandoshan_skull_knocker.iff",    "object/tangible/component/weapon/shared_vibro_unit.iff"},
