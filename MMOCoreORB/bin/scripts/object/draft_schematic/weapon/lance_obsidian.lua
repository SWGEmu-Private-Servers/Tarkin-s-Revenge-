object_draft_schematic_weapon_lance_obsidian = object_draft_schematic_weapon_shared_lance_obsidian:new {
   ...
   resourceTypes = {"steel_ditanium", "iron", "metal", "steel", "object/tangible/loot/dungeon/tarkin_custom/shared_obsidian_blade.iff",    "object/tangible/component/weapon/shared_vibro_unit.iff"},
