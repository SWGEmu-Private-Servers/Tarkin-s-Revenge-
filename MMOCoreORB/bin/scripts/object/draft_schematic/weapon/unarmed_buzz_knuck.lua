object_draft_schematic_weapon_unarmed_buzz_knuck = object_draft_schematic_weapon_shared_unarmed_buzz_knuck:new {
   ...
   resourceTypes = {"steel_duranium", "steel", "metal", "copper_platinite", "object/tangible/loot/dungeon/tarkin_custom/shared_stun_buzzer.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
