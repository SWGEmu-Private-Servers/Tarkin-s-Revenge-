object_draft_schematic_weapon_heavy_republic_flamethrower = object_draft_schematic_weapon_shared_heavy_republic_flamethrower:new {
   ...
   resourceTypes = {"aluminum_perovskitic", "iron", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_barrel_heavy_republic_flamethrower.iff", "steel", "object/tangible/component/weapon/shared_stock.iff"},
