object_draft_schematic_weapon_lance_shock = object_draft_schematic_weapon_shared_lance_shock:new {
   ...
   resourceTypes = {"aluminum_phrik", "iron", "metal", "aluminum", "object/tangible/loot/dungeon/tarkin_custom/shared_shock_lance_controller.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
