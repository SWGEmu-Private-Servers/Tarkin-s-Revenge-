object_draft_schematic_weapon_2h_sword_vibrosword = object_draft_schematic_weapon_shared_2h_sword_vibrosword:new {
   ...
   resourceTypes = {"iron_kammris", "aluminum_phrik", "petrochem_inert_polymer", "object/tangible/loot/dungeon/tarkin_custom/shared_vibro_sword_generator.iff",  "object/tangible/component/weapon/shared_reinforcement_core.iff"},
