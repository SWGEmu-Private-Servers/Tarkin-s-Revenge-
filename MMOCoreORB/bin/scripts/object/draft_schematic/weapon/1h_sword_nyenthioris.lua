object_draft_schematic_weapon_1h_sword_nyenthioris = object_draft_schematic_weapon_shared_1h_sword_nyenthioris:new {
   ...
   resourceTypes = {"aluminum_perovskitic", "metal", "copper_platinite", "object/tangible/loot/dungeon/tarkin_custom/shared_nyenthioris_blade.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
