object_draft_schematic_weapon_pistol_kashyyyk_stalker = object_draft_schematic_weapon_shared_pistol_kashyyyk_stalker:new {
   ...
   resourceTypes = {"steel_duralloy", "iron_kammris", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_bowframe_pistol_kashyyyk_stalker.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
