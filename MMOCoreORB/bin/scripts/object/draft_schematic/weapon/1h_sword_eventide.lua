object_draft_schematic_weapon_1h_sword_eventide = object_draft_schematic_weapon_shared_1h_sword_eventide:new {
   ...
   resourceTypes = {"iron", "steel", "metal", "aluminum", "object/tangible/loot/dungeon/tarkin_custom/shared_eventide_mace_head.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
