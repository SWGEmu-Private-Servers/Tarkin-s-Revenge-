object_draft_schematic_weapon_2h_sword_tulrus = object_draft_schematic_weapon_shared_2h_sword_tulrus:new {
   ...
   resourceTypes = {"steel_duranium", "copper_polysteel", "petrochem_inert_polymer","object/tangible/loot/dungeon/tarkin_custom/shared_tulrus_spike.iff",  "object/tangible/component/weapon/shared_sword_core.iff"},
