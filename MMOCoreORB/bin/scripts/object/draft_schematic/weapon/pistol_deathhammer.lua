object_draft_schematic_weapon_pistol_deathhammer = object_draft_schematic_weapon_shared_pistol_deathhammer:new {
   ...
   resourceTypes = {"steel", "aluminum", "chemical", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_barrel_pistol_deathhammer.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
