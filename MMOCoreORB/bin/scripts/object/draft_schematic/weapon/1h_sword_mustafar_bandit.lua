object_draft_schematic_weapon_1h_sword_mustafar_bandit = object_draft_schematic_weapon_shared_1h_sword_mustafar_bandit:new {
   ...
   resourceTypes = {"steel", "iron", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_bandit_blade.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
