object_draft_schematic_weapon_pistol_renegade = object_draft_schematic_weapon_shared_pistol_renegade:new {
   ...
   resourceTypes = {"steel_quadranium", "iron_kammris", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_muzzle_pistol_renegade.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
