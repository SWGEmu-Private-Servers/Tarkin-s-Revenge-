object_draft_schematic_weapon_lance_paragon = object_draft_schematic_weapon_shared_lance_paragon:new {
   ...
   resourceTypes = {"steel_quadranium", "steel", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_acid_distributor.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
