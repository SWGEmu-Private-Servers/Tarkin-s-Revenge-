object_draft_schematic_weapon_pistol_trando = object_draft_schematic_weapon_shared_pistol_trando:new {
   ...
   resourceTypes = {"steel_ditanium", "aluminum_linksteel", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_muzzle_pistol_trando.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
