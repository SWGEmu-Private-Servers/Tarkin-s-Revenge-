object_draft_schematic_weapon_pistol_jawa_ion = object_draft_schematic_weapon_shared_pistol_jawa_ion:new {
   ...
   resourceTypes = {"aluminum_linksteel", "copper_platinite", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_projectile_feed_mechanism.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_muzzle_pistol_jawa_ion.iff", "object/tangible/component/weapon/shared_scope_weapon.iff"},
