object_draft_schematic_weapon_2h_sword_darstaiis = object_draft_schematic_weapon_shared_2h_sword_darstaiis:new {
   ...
   resourceTypes = {"steel_quadranium", "copper_platinite", "petrochem_inert_polymer", "object/tangible/loot/dungeon/tarkin_custom/shared_darstaiis_blade.iff",  "object/tangible/component/weapon/shared_sword_core.iff"},
