object_draft_schematic_weapon_1h_sword_nova = object_draft_schematic_weapon_shared_1h_sword_nova:new {
   ...
   ingredientTitleNames = {"sword_core_jacket", "cutting_edge", "grip", "nova_blade", "reinforcement_core"},
   ingredientSlotType = {0, 0, 0, 1, 1},
   resourceTypes = {"iron_kammris", "metal", "aluminum_linksteel", "object/tangible/loot/dungeon/tarkin_custom/shared_nova_blade.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
