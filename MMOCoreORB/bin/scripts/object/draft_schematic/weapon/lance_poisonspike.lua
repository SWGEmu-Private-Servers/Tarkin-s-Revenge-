object_draft_schematic_weapon_lance_poisonspike = object_draft_schematic_weapon_shared_lance_poisonspike:new {
   ...
   resourceTypes = {"steel_duralloy", "iron", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_poison_edge.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
