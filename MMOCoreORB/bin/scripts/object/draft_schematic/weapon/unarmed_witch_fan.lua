object_draft_schematic_weapon_unarmed_witch_fan = object_draft_schematic_weapon_shared_unarmed_witch_fan:new {
   ...
   resourceTypes = {"steel_quadranium", "steel", "metal", "aluminum_linksteel", "object/tangible/loot/dungeon/tarkin_custom/shared_acid_fan_blade.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
