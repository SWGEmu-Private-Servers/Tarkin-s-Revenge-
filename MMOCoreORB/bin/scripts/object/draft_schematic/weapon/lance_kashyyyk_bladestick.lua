object_draft_schematic_weapon_lance_kashyyyk_bladestick = object_draft_schematic_weapon_shared_lance_kashyyyk_bladestick:new {
   ...
   resourceTypes = {"iron_kammris", "steel", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_kashyyyk_blade.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
