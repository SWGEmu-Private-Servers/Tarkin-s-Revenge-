object_draft_schematic_weapon_lance_cryo = object_draft_schematic_weapon_shared_lance_cryo:new {
   ...
   resourceTypes = {"steel_ditanium", "steel", "metal","object/tangible/loot/dungeon/tarkin_custom/shared_cryo_lance_compressor.iff",    "object/tangible/component/weapon/shared_vibro_unit.iff"},
