object_draft_schematic_weapon_1h_sword_xris = object_draft_schematic_weapon_shared_1h_sword_xris:new {
   ...
   resourceTypes = {"iron", "steel", "metal", "copper", "object/tangible/loot/dungeon/tarkin_custom/shared_xris_blade.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
