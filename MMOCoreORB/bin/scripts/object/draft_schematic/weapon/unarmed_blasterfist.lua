object_draft_schematic_weapon_unarmed_blasterfist = object_draft_schematic_weapon_shared_unarmed_blasterfist:new {
   ...
   resourceTypes = {"steel_ditanium", "iron", "metal", "copper_polysteel", "object/tangible/loot/dungeon/tarkin_custom/shared_blast_controller.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
