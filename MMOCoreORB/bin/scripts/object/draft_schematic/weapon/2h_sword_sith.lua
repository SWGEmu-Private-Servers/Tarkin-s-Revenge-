object_draft_schematic_weapon_2h_sword_sith = object_draft_schematic_weapon_shared_2h_sword_sith:new {
   ...
   resourceTypes = {"steel_ditanium", "aluminum_perovskitic", "petrochem_inert_polymer","object/tangible/loot/dungeon/tarkin_custom/shared_sith_blade.iff",  "object/tangible/component/weapon/shared_sword_core.iff"},
