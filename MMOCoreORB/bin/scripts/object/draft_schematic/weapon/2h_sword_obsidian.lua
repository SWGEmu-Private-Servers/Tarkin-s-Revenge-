object_draft_schematic_weapon_2h_sword_obsidian = object_draft_schematic_weapon_shared_2h_sword_obsidian:new {
   ...
   resourceTypes = {"steel_duralloy", "aluminum_phrik", "petrochem_inert_polymer","object/tangible/loot/dungeon/tarkin_custom/shared_obsidian_blade.iff",  "object/tangible/component/weapon/shared_sword_core.iff"},
