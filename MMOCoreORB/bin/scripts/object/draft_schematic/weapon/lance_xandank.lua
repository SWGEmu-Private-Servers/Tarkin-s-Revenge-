object_draft_schematic_weapon_lance_xandank = object_draft_schematic_weapon_shared_lance_xandank:new {
   ...
   resourceTypes = {"steel_quadranium", "iron", "metal","object/tangible/loot/dungeon/tarkin_custom/shared_xandank_tooth.iff",    "object/tangible/component/weapon/shared_vibro_unit.iff"},
