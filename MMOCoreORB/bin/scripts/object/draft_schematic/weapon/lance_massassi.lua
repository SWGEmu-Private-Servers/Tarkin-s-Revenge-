object_draft_schematic_weapon_lance_massassi = object_draft_schematic_weapon_shared_lance_massassi:new {
   ...
   resourceTypes = {"aluminum_perovskitic", "iron", "metal","object/tangible/loot/dungeon/tarkin_custom/shared_double_massassi_blade.iff",    "object/tangible/component/weapon/shared_vibro_unit.iff"},
