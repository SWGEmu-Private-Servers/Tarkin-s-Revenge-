object_draft_schematic_weapon_lance_kaminoan = object_draft_schematic_weapon_shared_lance_kaminoan:new {
   ...
   resourceTypes = {"steel_quadranium", "iron", "metal", "steel", "object/tangible/loot/dungeon/tarkin_custom/shared_kaminoan_staff_rod.iff",   "object/tangible/component/weapon/shared_vibro_unit.iff"},
