object_draft_schematic_weapon_rifle_alliance_gauss = object_draft_schematic_weapon_shared_rifle_alliance_gauss:new {
   ...
   resourceTypes = {"steel_duralloy", "copper_polysteel", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_barrel_rifle_alliance_gauss.iff",
