object_draft_schematic_weapon_unarmed_massassi = object_draft_schematic_weapon_shared_unarmed_massassi:new {
   ...
   resourceTypes = {"steel_quadranium", "iron", "metal", "aluminum_phrik", "object/tangible/loot/dungeon/tarkin_custom/shared_kath_hound_fang.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
