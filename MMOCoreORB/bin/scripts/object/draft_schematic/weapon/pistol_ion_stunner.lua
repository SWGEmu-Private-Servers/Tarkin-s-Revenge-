object_draft_schematic_weapon_pistol_ion_stunner = object_draft_schematic_weapon_shared_pistol_ion_stunner:new {
   ...
   resourceTypes = {"steel_ditanium", "iron_kammris", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/tarkin_custom/shared_coil_pistol_ion_stunner.iff",
