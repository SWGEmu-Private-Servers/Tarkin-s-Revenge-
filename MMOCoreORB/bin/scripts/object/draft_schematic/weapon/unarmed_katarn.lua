object_draft_schematic_weapon_unarmed_katarn = object_draft_schematic_weapon_shared_unarmed_katarn:new {
   ...
   resourceTypes = {"steel_duralloy", "steel", "metal", "copper_platinite", "object/tangible/loot/dungeon/tarkin_custom/shared_katarn_claw.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
