object_draft_schematic_weapon_unarmed_tenebrous = object_draft_schematic_weapon_shared_unarmed_tenebrous:new {
   ...
   resourceTypes = {"steel_duralloy", "aluminum", "metal", "copper_polysteel", "object/tangible/loot/dungeon/tarkin_custom/shared_phantom_blade_generator.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
