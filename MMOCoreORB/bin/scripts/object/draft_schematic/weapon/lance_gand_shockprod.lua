object_draft_schematic_weapon_lance_gand_shockprod = object_draft_schematic_weapon_shared_lance_gand_shockprod:new {
   ...
   resourceTypes = {"steel_duralloy", "iron", "metal","object/tangible/loot/dungeon/tarkin_custom/shared_shock_prodder.iff",    "object/tangible/component/weapon/shared_vibro_unit.iff"},
